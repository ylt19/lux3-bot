...
from pathfinding import Grid, DiagonalMovement
...
ALL_ALGORITHMS = [pf.BFS] + SHORTEST_PATH_ALGORITHMS


class TestSimpleGrid(unittest.TestCase):
    """
    pytest pathfinding/tests/test_grid_pathfinding.py::TestSimpleGrid
    """
